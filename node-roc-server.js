...
// NOSQL
var nosql = require('nosql').load('./roc.nosql');
...
var callbackCount = nosql.stored.execute('counter', { increment: 1 });
//END declarations

//nosql.stored.execute('counter', { increment: 1 });
app.get('/', function(req, res){
  res.send('hello world');
 	nosql.insert({ sicard: req.query.sicard, control: req.query.control, time: req.query.time }, callbackCount);
  console.log(req.ip); 
  console.log(req.query.sicard,req.query.control,req.query.time,callbackCount);
